...
/*
This is class for animated fliipinf of stories
...
public abstract class AdapterViewAnimator extends AdapterView<Adapter>
    ...
    public AdapterViewAnimator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.AdapterViewAnimatorHorizontal, defStyleAttr, 0);
        int resource = a.getResourceId(
                R.styleable.AdapterViewAnimatorHorizontal_inAnimationHorizontal, 0);
        if (resource > 0) {
        ...
        resource = a.getResourceId(R.styleable.AdapterViewAnimatorHorizontal_outAnimationHorizontal, 0);
        if (resource > 0) {
        ...
        boolean flag = a.getBoolean(
                R.styleable.AdapterViewAnimatorHorizontal_animateFirstViewHorizontal, true);
        setAnimateFirstView(flag);

        mLoopViews = a.getBoolean(
                R.styleable.AdapterViewAnimatorHorizontal_loopViewsHorizontal, false);
